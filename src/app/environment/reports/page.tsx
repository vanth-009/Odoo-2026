...
import ReportsManager from '@/environment/components/ReportsManager';
...
export default async function EnvironmentalReportsPage() {
  try {
    ...
    console.error('Failed to load reporting database entities on server:', error);
    return (
        ...
        <div className="max-w-md w-full bg-zinc-900 border border-zinc-800 rounded-2xl p-6 text-center space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-xs text-zinc-400 leading-relaxed">
              The EcoSphere Reporting Center needs to connect to the MySQL database. 
