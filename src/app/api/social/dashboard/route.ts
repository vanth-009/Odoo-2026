...
export async function GET(_request: NextRequest) {
  try {
    ...
    const [
      ...
      prisma.csrParticipation.aggregate({
    ...
    const topParticipantsRaw = await prisma.csrParticipation.groupBy({
      by: ['employeeId'],
      _sum: { pointsEarned: true },
    ...
    const recentParticipations = await prisma.csrParticipation.findMany({
      where: {
