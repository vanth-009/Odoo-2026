        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-4 items-end">
          ...
          <div>
            ...
            <select
              ...
              className="w-full bg-black/45 border border-white/10 rounded-lg px-2 py-1.5 text-xs text-white focus:outline-none focus:border-emerald-500/50"
            >
          ...
          <div>
            ...
            <input
              ...
              className="w-full bg-black/45 border border-white/10 rounded-lg px-2 py-1 text-xs text-white [color-scheme:dark] focus:outline-none"
            />
          </div>
          ...
          <div>
            ...
            <select
              ...
              className="w-full bg-black/45 border border-white/10 rounded-lg px-2 py-1.5 text-xs text-white focus:outline-none disabled:opacity-50"
            >
