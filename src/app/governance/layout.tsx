...
const navItems = [
  { label: "Dashboard Overview", href: "/governance", icon: LayoutDashboard },
  { label: "Policies & Standards", href: "/governance/policies", icon: FileText },
  { label: "Audits & Findings", href: "/governance/audits", icon: Calendar },
  { label: "Compliance & Evidence", href: "/governance/compliance", icon: Shield },
  { label: "Governance Reports", href: "/governance/reports", icon: FileSpreadsheet },
];
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-y-auto z-10 relative">
        ...
        <header className="h-16 border-b border-[#1f1f23]/30 px-8 flex items-center justify-between bg-[#09090b]/50 backdrop-blur-md shrink-0">
          <div className="flex flex-col">
            ...
            <h1 className="text-sm font-extrabold text-[#f4f4f5] tracking-tight -mt-0.5">Corporate Governance Console</h1>
          </div>
        </header>
