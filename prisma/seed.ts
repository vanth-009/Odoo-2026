...
async function main() {
  ...
  const employeeData = [
    ...
    { code: 'EMP011', first: 'Taylor', last: 'Morgan', email: 'taylor.morgan@ecosphere.com', phone: '+1-415-555-0111', deptIdx: 0, designation: 'Security Engineer', gender: Gender.NON_BINARY, dob: '1995-04-28', ethnicity: 'Caucasian', join: '2023-06-05', status: EmployeeStatus.ACTIVE },
    ...
    { code: 'EMP050', first: 'Jordan', last: 'Rivera', email: 'jordan.rivera@ecosphere.com', phone: '+1-415-555-0150', deptIdx: 7, designation: 'UX Designer', gender: Gender.NON_BINARY, dob: '1997-08-10', ethnicity: 'Hispanic', join: '2024-01-15', status: EmployeeStatus.ACTIVE },
  ]
  ...
  const csrActivities = await Promise.all([
    ...
    prisma.csrActivity.create({
      data: {
        ...
        xpReward: 20,
        status: ActivityStatus.COMPLETED,
        imageUrl: 'https://images.unsplash.com/photo-1592424001844-325d2c67c293?auto=format&fit=crop&w=800&q=80',
